...
// Cloned from https://github.com/sqfmi/Watchy/tree/master/examples/WatchFaces/StarryHorizon 

#include <Watchy.h> //include the Watchy library
#include "Orbitron_Bold_52.h" //AX
#include "Orbitron_Medium_20.h" //AX
#include "stars.h"
#include "settings.h"
...
//          printf("Minute %d, angle %f\n", (int)currentTime.Minute, minuteAngle);
        ...
        void drawTime() {
          display.setFont(&Orbitron_Bold_52); //AX
          display.setTextColor(GxEPD_WHITE);
          display.setTextWrap(false);
          char* timeStr;
          asprintf(&timeStr, "%d:%02d", currentTime.Hour, currentTime.Minute);
          drawCenteredString(timeStr, 100, 80, true); //AX
          free(timeStr);
        }
        ...
        void drawDate() {
          ...
          display.setFont(&Orbitron_Medium_20); //AX
          display.setTextColor(GxEPD_WHITE);
          display.setTextWrap(false);
          char* dateStr;
        ...
        void drawStepsAndBattery(){
          ...
          asprintf(&batteryLevel2, "%d", batteryLevel);

          asprintf(&batteryAndStep, "%d   %d", batteryLevel, sensor.getCounter());

          drawCenteredString(batteryAndStep, 100, 145, true);
...
//          printf("bounds: %d x %d y, %d x1 %d y1, %d w, %d h\n", 0, 100, x1, y1, w, h);
          ...
          if(drawBg) {
            int padY = 3;
            int padX = 5; // Original value is 10
